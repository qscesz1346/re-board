...
export default function BoardWrite() {
  ...
  const onTitleChangeHanlder = (event: ChangeEvent<HTMLTextAreaElement>) => {
      ...
      <div className='board-write-container'>
        <div className='board-write-box'>
          <div className='board-write-title-box'>
            <textarea ref={titleRef} className='board-write-title-textarea' rows={1} placeholder='제목을 작성해주세요.' value={title} onChange={onTitleChangeHanlder} />
          </div>
